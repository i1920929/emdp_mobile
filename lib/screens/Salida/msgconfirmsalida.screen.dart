...
class MsgConfirmSalidaScreen extends StatefulWidget {
  @override
  _MsgConfirmSalidaScreenState createState() => _MsgConfirmSalidaScreenState();
}

class _MsgConfirmSalidaScreenState extends State<MsgConfirmSalidaScreen> {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Registro de Salida', textAlign: TextAlign.right,
                    style: TextStyle(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text(
                  '¡Tu salida a sido  registrado satisfactoriamente!',
