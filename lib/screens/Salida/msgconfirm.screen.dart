...
class MsgConfirmScreen extends StatefulWidget {
  @override
  _MsgConfirmScreenState createState() => _MsgConfirmScreenState();
}

class _MsgConfirmScreenState extends State<MsgConfirmScreen> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text(
                  '¡Tu confirmación a sido  registrado satisfactoriamente!',
